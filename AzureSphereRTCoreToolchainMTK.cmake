...
if(DEFINED ARM_GNU_PATH AND (NOT ARM_GNU_PATH STREQUAL ""))
    ...
    find_program(ARM_GNU_FIND_PATH arm-none-eabi-gcc)
    if(ARM_GNU_FIND_PATH STREQUAL "ARM_GNU_FIND_PATH-NOTFOUND")
        message(FATAL_ERROR "Arm GNU Toolchain not found. Please add the binary folder to the PATH or set the ArmGnuPath environment variable as described in https://docs.microsoft.com/en-us/azure-sphere/app-development/build-rt-app")
    endif()

    string(FIND ${ARM_GNU_FIND_PATH} "/" ARM_GNU_FIND_PATH_END REVERSE)
    string(SUBSTRING ${ARM_GNU_FIND_PATH} 0 ${ARM_GNU_FIND_PATH_END} ARM_GNU_BIN_PATH)
    string(FIND ${ARM_GNU_BIN_PATH} "/" ARM_GNU_BIN_PATH_END REVERSE)
    string(SUBSTRING ${ARM_GNU_BIN_PATH} 0 ${ARM_GNU_BIN_PATH_END} ARM_GNU_BASE_PATH)
    set(ENV{ArmGnuBasePath} ${ARM_GNU_BASE_PATH})
    set(ENV{ArmGnuBinPath} ${ARM_GNU_BIN_PATH})
endif()
...
if(${CMAKE_HOST_WIN32})
    ...
    set(CMAKE_CXX_COMPILER "${ARM_GNU_BIN_PATH}/arm-none-eabi-g++" CACHE INTERNAL "Path to the C++ compiler in the ARM embedded toolset targeting Real-Time Core")
